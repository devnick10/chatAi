...
const PaymentModel = () => {
    ...
    async function payNow() {
        ...
        const res = await api.get('/billing/init-subscribe', {
            headers: {
                'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiIwMUs2RDYwUllLN1I1MEZWSFRCNEtDVjFKUSIsImlhdCI6MTc1OTIzODU0Nn0.YAQUKrLAaOqClf6PthXNsdF8zkE5L3MNfvGk9thUKxI'
            }
        })
