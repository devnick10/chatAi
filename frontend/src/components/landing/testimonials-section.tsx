...
const TestimonialSection: React.FC = () => {
  ...
  return (
    <section
      id="testimonials"
      className="w-full mt-16 grid grid-cols-1 divide-y divide-neutral-600"
    >
      <SectionHeading
        heading={"One AI For All Your Needs"}
        description={
          "One intelligent assistant that helps with everything in your life. From answering questions and writing content to planning and problem-solving - all in one place, all with one AI."
        }
      />
