...
export default function PricingSection() {
  return (
    <section
      id={"pricing"}
      className="w-full  mt-16 sm:mt-0 grid grid-cols-1 divide-y divide-neutral-600"
    >
      <SectionHeading
        heading={"Affordable AI - Powered Plan"}
        description={
          "Get 100 monthly credits to power your AI conversations and boost your productivity"
        }
      />
