...
-- CreateIndex
CREATE UNIQUE INDEX "PaymentHistory_currency_key" ON "public"."PaymentHistory"("currency");

-- CreateIndex
CREATE UNIQUE INDEX "PaymentHistory_userId_key" ON "public"."PaymentHistory"("userId");
